...
@property (nonatomic, retain, readonly) UIColor *color;           //!< The color in which the normal icon should be displayed
@property (nonatomic, retain, readonly) UIColor *selectedColor;   //!< The color in which the selected icon should be displayed
@property (nonatomic, retain, readonly) UIColor *alternateColor;  //!< The color in which the alternate icon should be displayed
@property (nonatomic, retain, readonly) NSString *title;          //!< The title of the trigger in the normal state
@property (nonatomic, retain, readonly) NSString *selectedTitle;  //!< The title of the trigger in the selected state
@property (nonatomic, retain, readonly) NSString *alternateTitle; //!< The title of the trigger in the alernate state
@end
